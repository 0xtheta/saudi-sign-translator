...
import { Database, Languages, Trash2, Upload } from 'lucide-react'
import {
  createAnimation,
  createPhrase,
  loadAdminState,
...
function ConnectionCard({ state, label }) {
  return (
    <div className="admin-stat-card admin-stat-card--connection">
      <div className={`admin-connection-dot admin-connection-dot--${state}`} />
      <div>
        <p className="admin-stat-label">Connection</p>
        <p className="admin-stat-value">{label}</p>
      </div>
    </div>
  )
}
...
export function AdminApp() {
  ...
  const connectionState = isLoading ? 'loading' : errorMessage ? 'disconnected' : 'connected'
    ...
    <div className="admin-shell">
      ...
      <div className="admin-container">
        ...
        <section className="grid gap-3 md:grid-cols-3">
          ...
          <ConnectionCard state={connectionState} label={connectionLabel} />
        </section>
        ...
        <section className="admin-workspace">
          <section className="admin-panel">
            <div className="admin-panel__row admin-panel__row--tight">
              ...
              <span className="admin-mini-tag">Step 1</span>
            </div>
            <form className="grid gap-3.5" onSubmit={addAnimation}>
              ...
              <div className="admin-upload-row">
                ...
                <div className="admin-inline-note admin-inline-note--stacked">
          ...
          <section className="admin-panel">
            <div className="admin-panel__row admin-panel__row--tight">
              ...
              <span className="admin-mini-tag">Step 2</span>
            </div>
        ...
        <section className="admin-panel admin-panel--library">
          <div className="admin-panel__row">
            <div>
              <h2 className="admin-panel__title">Animation library</h2>
              <p className="admin-panel__subtle">Manage uploaded clips and their approved aliases.</p>
            </div>
            <input
              value={filterText}
                      ...
                      linkedPhrases.map((phrase) => (
                        <div key={phrase.id} className="admin-phrase-row">
                          <div className="min-w-0">
                            ...
                            <p className="mt-1 text-xs text-white/38">{phrase.text_normalized}</p>
                          </div>
                          <button
                            type="button"
